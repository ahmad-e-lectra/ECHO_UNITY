...
# 9 "C:/msys64/ucrt64/include/setjmp.h" 3
...
#pragma pack(push,_CRT_PACKING)
# 112 "C:/msys64/ucrt64/include/setjmp.h" 3
...
# 201 "C:/msys64/ucrt64/include/setjmp.h" 3
...
# 243 "C:/msys64/ucrt64/include/setjmp.h" 3
...
# 11 "build/test/mocks/test_Blinky/mock_gpio.h"
#pragma GCC diagnostic push
...
void SysCtl_delay_CMockExpect(UNITY_UINT cmock_line, uint32_t count);
...
void GPIO_writePin_CMockExpect(UNITY_UINT cmock_line, uint32_t pin, uint32_t val);
...
void GPIO_setDirectionMode_CMockExpect(UNITY_UINT cmock_line, uint32_t pin, GPIO_Direction pinIO);
...
void GPIO_readPin_CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint32_t cmock_to_return);

void GPIO_readPin_CMockStopIgnore(void);


void GPIO_readPin_CMockExpectAndReturn(UNITY_UINT cmock_line, uint32_t pin, uint32_t cmock_to_return);
...
# 86 "build/test/mocks/test_Blinky/mock_gpio.h"
#pragma GCC diagnostic pop
# 8 "test/test_Blinky.c" 2
# 1 "build/test/mocks/test_Blinky/mock_device.h" 1
# 11 "build/test/mocks/test_Blinky/mock_device.h"
#pragma GCC diagnostic push
...
# 38 "build/test/mocks/test_Blinky/mock_device.h"
#pragma GCC diagnostic pop
